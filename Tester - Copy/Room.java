...
public class Room{
    ...
    public Room(String roomType, int level) throws org.newdawn.slick.SlickException
    {
        ...
        {
            playerRoom = new TiledMap("StartingRoomFinal.tmx", "");
            enemies = new NPC[0];
        }
